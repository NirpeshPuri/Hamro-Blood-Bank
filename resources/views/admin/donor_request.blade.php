...
@section('content')
    ...
    <div class="request-container">
        <h2 class="request-header">Donor Blood Requests</h2>
            ...
            <table class="request-table">
                ...
                @forelse($requests as $request)
                    <tr>
                        ...
                        <td>{{ $request->donation_date ? \Carbon\Carbon::parse($request->donation_date)->format('M d, Y') : 'Not set' }}</td>
                        <td>
                            <form action="{{ route('admin.donor.update-status', $request->id) }}" method="POST">
                                @csrf
